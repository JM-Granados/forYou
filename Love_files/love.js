(function(window){
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        ...
        // Paleta de colores para los corazones - tonos rojos, rosados, naranjas y beige
        var colors = [
            'rgb(139, 0, 0)',      // Rojo oscuro (dark red)
            'rgb(165, 42, 42)',    // Rojo marrón (brown red)
            'rgb(220, 20, 60)',    // Carmesí (crimson)
            'rgb(255, 0, 0)',      // Rojo puro (red)
            'rgb(255, 20, 147)',   // Rosa profundo (deep pink)
            'rgb(255, 105, 180)',  // Rosa brillante (hot pink)
            'rgb(255, 182, 193)',  // Rosa claro (light pink)
            'rgb(255, 192, 203)',  // Rosa suave (pink)
            'rgb(255, 99, 71)',    // Tomate (tomato)
            'rgb(255, 127, 80)',   // Coral (coral)
            'rgb(255, 160, 122)',  // Salmón claro (light salmon)
            'rgb(255, 228, 181)',  // Melocotón (moccasin)
            'rgb(255, 218, 185)',  // Melocotón claro (peach puff)
            'rgb(230, 100, 140)',  // Rosa oscuro
            'rgb(200, 50, 100)',   // Rosa magenta oscuro
        ];
        
        this.color = color || colors[random(0, colors.length - 1)];
